namespace PresentationStyles
{
    ...
    /// </summary>
    [PresentationStyleExport("Farmhand", "Farmhand", Version = AssemblyInfo.ProductVersion,
        Copyright = AssemblyInfo.Copyright, Description = "A custom presentation style for Farmhand.")]
    public sealed class Farmhand : PresentationStyleSettings
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Farmhand"/> class. 
        /// </summary>
        public Farmhand()
        {
            // The base path of the presentation style files relative to the assembly's location
            this.BasePath = "Farmhand";
            ...
            this.DocumentModelTransformation =
                new TransformationFile(
                    @"%SHFBROOT%\ProductionTransforms\ApplyVSDocModel.xsl",
            ...
            this.IntermediateTocTransformation =
                new TransformationFile(@"%SHFBROOT%\ProductionTransforms\CreateVSToc.xsl");
            ...
            this.TransformComponentArguments.Add(
                new TransformComponentArgument(
                    "logoFile",
                    true,
                    true,
                    null,
