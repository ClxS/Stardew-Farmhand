...
1) Repair Stardew Valley and xTile references. These will be located in: Libraries/Revolution, Mods/ModLoaderMod (xTile only)  (**do not touch the Stardew Revolution references or try to add new references to fix errors**) 
