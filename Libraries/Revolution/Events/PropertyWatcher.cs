...
namespace Revolution.Events
{
    internal class PropertyWatcher
    {
        ...
        private void CheckPropertyChanges()
        {
            ...
            {
                Revolution.Events.LocationEvents.InvokeCurrentLocationChanged(PreviousGameLocation, Game1.currentLocation);
                PreviousGameLocation = Game1.currentLocation;
            }

            if (Game1.player != null && Game1.player != PreviousFarmer)
            {
                Revolution.Events.PlayerEvents.InvokeFarmerChanged(PreviousFarmer, Game1.player);
