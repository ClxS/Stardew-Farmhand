namespace Farmhand.API.Items
{
    ...
    public static class BigCraftable
    {
        ...
        [HookRedirectConstructorToMethod("StardewValley.Menus.LetterViewerMenu", ".ctor")]
        [HookRedirectConstructorToMethod("StardewValley.MultiplayerUtility", ".ctor")]
        [HookRedirectConstructorToMethod("StardewValley.MultiplayerUtility", "performObjectAlteration")]
        [HookRedirectConstructorToMethod("StardewValley.MultiplayerUtility", "performSwitchHeldItem")]
        [HookRedirectConstructorToMethod("StardewValley.MultiplayerUtility", "serverTryToPerformObjectAlteration")]
