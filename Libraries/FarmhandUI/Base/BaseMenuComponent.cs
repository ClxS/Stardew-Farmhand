    ...
    public abstract class BaseMenuComponent : IMenuComponent
    {
        ...
        protected void SetScaledArea(Rectangle scaledArea)
        {
            this.area = new Rectangle(
                scaledArea.X * Game1.pixelZoom,
                scaledArea.Y * Game1.pixelZoom,
                scaledArea.Width * Game1.pixelZoom,
                scaledArea.Height * Game1.pixelZoom);
        }
