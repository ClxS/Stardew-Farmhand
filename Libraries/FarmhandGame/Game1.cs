                ...
                else
                {
                        ...
                        using (var enumerator = currentLocation.characters.GetEnumerator())
                        {
                            while (enumerator.MoveNext())
                            {
                                ...
                                if (current != null && !current.swimming && !current.hideShadow && !current.IsMonster
                                    && !currentLocation.shouldShadowBeDrawnAboveBuildingsLayer(
                                        current.getTileLocation()))
                                {
                                    spriteBatch.Draw(
                                        shadowTexture,
                                        GlobalToLocal(
                                            ...
                                            + new Vector2(
                                                ...
                                                current.GetBoundingBox().Height
                                                + (current.IsMonster ? 0 : pixelZoom * 3))),
                                    ...
                                    spriteBatch.Draw(
                                        ...
                                        GlobalToLocal(
                                            ...
                                            + new Vector2(
                                                ...
                                                current3.GetBoundingBox().Height
                                                + (current3.IsMonster ? 0 : pixelZoom * 3))),
                                        shadowTexture.Bounds,
                                        Color.White,
                                        0f,
                                        new Vector2(shadowTexture.Bounds.Center.X, shadowTexture.Bounds.Center.Y),
                    ...
                    if (tvStation >= 0)
                    {
                        spriteBatch.Draw(
                            ...
                            GlobalToLocal(
                                viewport,
                                new Vector2(6 * tileSize + tileSize / 4, 2 * tileSize + tileSize / 2)),
                    ...
                    if (panMode)
                    {
                        spriteBatch.Draw(
                            fadeToBlackRect,
                            new Rectangle(
                                (int)Math.Floor((getOldMouseX() + viewport.X) / (double)tileSize) * tileSize
                                - viewport.X,
                                (int)Math.Floor((getOldMouseY() + viewport.Y) / (double)tileSize) * tileSize
                                - viewport.Y,
                                tileSize,
                                tileSize),
                            Color.Lime * 0.75f);
                    ...
                    if (currentLocation.Name.Equals("Farm") && stats.SeedsSown >= 200u)
                    {
                        ...
                        spriteBatch.Draw(
                            ...
                            GlobalToLocal(
                                viewport,
                                new Vector2(4 * tileSize + tileSize / 5, 2 * tileSize + tileSize / 3)),
                            getSourceRectForStandardTileSheet(debrisSpriteSheet, 16),
                            Color.White);
                    }
                        ...
                        drawPlayerHeldObject(player);
                             ...
                             && (currentLocation.Map.GetLayer("Front")
                                 ...
                                 || currentLocation.Map.GetLayer("Front")
                                     .PickTile(
                                         new Location(
                                             player.GetBoundingBox().Right,
                                             (int)player.position.Y - tileSize * 3 / 5),
                                         viewport.Size) != null
                                 && !currentLocation.Map.GetLayer("Front")
                                     .PickTile(
                                         new Location(
                            ...
                            new object[]
                                {
                                    ...
                                    Environment.NewLine, "debugOutput: ",
                                    debugOutput
                                }),
                        new Vector2(
